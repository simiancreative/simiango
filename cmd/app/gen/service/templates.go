...
// @ID {{ServiceName}}
// @Produce  json
// @Success [replace with vlaid response code] {object} [replace with reposne struct]
// @Failure [replace with error code] {object} errors.ErrorResult "[replace with error_name]"
